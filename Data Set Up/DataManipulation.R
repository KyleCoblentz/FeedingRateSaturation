###########################################################################################
### Cleaning the data to examine the saturation of predator functional responses at 
...
### drop existing abundance and frac_ columns


Abundance <- matrix(nrow = 2181, ncol = 9)
...
colnames(forage)[60:68] <- c('frac_10', 'frac_20', 'frac_30',
                             'frac_40', 'frac_50', 'frac_60',
                             'frac_70', 'frac_80', 'frac_90')
